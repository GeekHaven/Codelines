...
const unsigned long long int mod = ((1<<63) - 1)*2 - 57;     //mod should be unsing long long int to handle such big value
...
vector <unsigned long long int> computeHash(char *str)
{
    vector <unsigned long long int> hash_values(strlen(str));
...
unsigned long long int binpow(unsigned long long int a,unsigned long long int b,unsigned long long int m)
{
	long long int res=1;
	while(b>0)
	{
...
int main()
{
	...
	vector <unsigned long long int> hash_prefix = computeHash(str);
	vector <unsigned long long int> hash_suffix(strlen(str)-1);
	...
	map <unsigned long long int,long long int> m_prefix;
	map <unsigned long long int,long long int> m_suffix;
